...
4. Прогнать чек-лист из `_docs/mvp.md` §5 «Критерии приёмки» — все 10 пунктов отметить как выполненные (зафиксировать результаты в финальном коммите или в `_board/progress.txt`).
